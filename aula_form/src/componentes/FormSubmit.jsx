...
// Aqui utilizaremos useState para armanezar o valor dos inputs. Os eventos para formulários será o onSubmit
...
export default function FormSubmit(){
    ...
    const handleSubmit = (e) => {
        ...
        //dessa forma. para resetar o formulário acionamos os set dos states com valores vazios. Os valores ainda vão para o console
